      ...
      <AppBar position="static" sx={{ color: 'white', background: '#14142b', marginTop: '40px', marginBottom: '20px' }}>
        ...
        <Toolbar sx={{ justifyContent: 'space-between', marginTop: '2px', borderBottom: '0.2px solid' }}>
          ...
          <Box sx={{ display: 'flex', paddingBottom: '60px', alignItems: 'center' }}>
            ...
            <Typography variant="body2" sx={{ display: { xs: 'none', sm: 'none', md: 'none', lg: 'block' }}}>18°</Typography>
            <Typography
                  variant="body2"
                  sx={{
                    margin: '0 8px',
            ...
            <Typography variant="body2" sx={{ display: { xs: 'none', sm: 'none', md: 'none', lg: 'block' }}}> {new Date().toLocaleTimeString('en-US', { day: 'numeric', month: 'short', dayPeriod: 'short' })}</Typography>
